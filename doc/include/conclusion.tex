...
In addition, the user is free to replace the data model described in \sref{data-model}, which consists of the power and temperature components, with another model, serving the same purpose, if this change is considered to be more beneficial in a different context.

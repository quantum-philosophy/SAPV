...
\begin{document}
  \title{Temperature-driven Uncertainty Quantification of\\Process Variation for Multiprocessor System Design}
  ...
  \section{Problem Formulation and Solution} \slabel{problem-formulation}

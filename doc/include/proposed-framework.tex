In this section, we present our UQ framework developed around the idea of the temperature-based characterization of process variation. The approach is based on Bayesian inference, which is introduced in the appendix, \aref{bayesian-inference}.

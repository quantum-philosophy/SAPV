In order to give a clear presentation of the proposed technique, we first provide an overview of the major components of Bayesian inference \cite{gelman2004}.

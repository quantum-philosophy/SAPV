...
Hence, $\u$ can be seen as a square-integrable stochastic process (field) $\u: \outcomes \times \domain \to \real$ defined over a spatial domain $\domain$ corresponding to the wafer (see also \aref{kl-expansion} and \cite{durrett2010}).

...
Therefore, the technique in \cite{zhang2010} is impractical for the majority of process parameters since the corresponding direct measurements have undesirable implications as we shall discuss in \sref{motivation}.

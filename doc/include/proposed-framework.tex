...
At Stage~2, we undertake an auxiliary procedure that delivers an optimized proposal distribution for the MCMC sampling stage, Stage~3.
...
As shown in \fref{algorithm}, Stages 2 and 3 actively communicate with two models, call the forward and statistical models, which we shall start our presentation from in the following subsections.

...
This behavior is expected as the granularity of the utilized thermal model (see \sref{data-model} and \cite{ukhov2012}) is binded to the number of processing elements; therefore, the temperature simulations become more intense.

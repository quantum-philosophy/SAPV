...
The parameters $\mu_0$ and $\tau_\u$ of the priors in \eref{mu-u-prior} and \eref{sigma2-u-prior}, respectively, are specific to the considered technological process; we set $\mu_0$ to the nominal value of $\u$ and $\tau_\u$ to 5\% of $\mu_0$ \cite{juan2012}.
The parameters $\sigma_0$ and $\nu_\u$ in \eref{mu-u-prior} and \eref{sigma2-u-prior}, respectively, determine the precision of the information on $\mu_0$ and $\tau_\u$ and are set according to the beliefs of the user; we set $\sigma_0$ to 1\% of $\mu_0$ and $\nu_\u$ to 10.

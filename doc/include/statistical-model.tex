...
At this point, we have obtained the two pieces of the posterior shown in \eref{bayes}: the likelihood function, which is the density in \eref{likelihood}, and the prior, which is the product of the densities in \eref{z-prior}--\eref{sigma2-noise-prior}. Thus, the posterior is

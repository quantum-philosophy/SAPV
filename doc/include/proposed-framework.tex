...
As it can be seen in \fref{algorithm}, Stage~2 and Stage~3 actively communicate with two models on the right, called the forward and statistical models, which we shall discuss next.

In this section, we present our framework for the temperature-based characterization of process variations. The approach is based on Bayesian inference, which is introduced in the appendix, \aref{bayesian-inference}.

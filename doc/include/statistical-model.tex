...
In order to infer them, we employ the procedure described in the following subsections; we shall refer to this procedure as the statistical model (see \fref{algorithm}). The statistical model closely follows the general Bayesian approach outlined in \sref{bayesian-inference} and consists of the five components depicted in \fref{inference}.

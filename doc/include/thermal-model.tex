Using the information in $\specification$ (see \sref{problem-formulation}), we construct a so-called thermal RC circuit of the system that captures the thermal behavior of a single die on the wafer \cite{kreith2000}.
